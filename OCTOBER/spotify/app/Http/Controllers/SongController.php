...
class SongController extends Controller
{
    ...
    public function orWhere(){
        $data = Song::where('author', 'Rick Astley')->orWhere('name', 'Baby Mandala')->get();
    ...
    public function andWhere(){
        $data = Song::where('author', 'Rick Astley')->where('name', 'Never gonna give you up')->get();
