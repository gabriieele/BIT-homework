...
<table class="table table-striped mt-4">
  ...
  <tr >
      <th></th>
      <td><a href = "../audio/audio.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
